...
namespace OpenCodeList
{
    ...
    /// </summary>
    public class CodeListDocumentRef : DocumentRef
    {
        /// <summary>
        ...
        /// <returns>A new <see cref="CodeListDocumentRef"/> instance</returns>
        internal static CodeListDocumentRef Parse(JsonElement jsonElement)
        {
            var documentRef = new CodeListDocumentRef();
