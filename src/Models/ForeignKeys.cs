...
/// </summary>
public sealed class ForeignKeys : Owned<CodeListDocument>, IEnumerable<ForeignKey>
{
    ...
    internal ForeignKeys(CodeListDocument owner)
        : base(owner)
    {
    }
    ...
    public bool Any(Func<ForeignKey, bool> predicate)
    {
    ...
    public int IndexOf(Func<ForeignKey, bool> predicate)
    {
        ...
        return _foreignKeys.FindIndex(foreignKey => predicate(foreignKey));
    }
    ...
    internal void ParseAndAdd(JsonElement jsonElement)
    {
        ...
        foreach (var jsonArrayElement in jsonElement.EnumerateArray())
        {
            ...
            {
                _foreignKeys.Add(ForeignKey.Parse(Owner, jsonArrayElement));
            }
            else
            {
